...
const SyllabusOverview = ({ onNavigate, onSelectUnit }) => {
  ...
  return (
    <section className="py-24 bg-[#050816] relative overflow-hidden" id="syllabus">
      {/* Background Elements */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          <Badge className="mb-4 bg-violet-500/10 text-violet-400 border-violet-500/30 px-4 py-1">
            Complete Curriculum
          </Badge>
          <h2 className="text-4xl sm:text-5xl font-bold text-white mb-4">
            Course <span className="bg-gradient-to-r from-violet-400 to-fuchsia-400 bg-clip-text text-transparent">Syllabus</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
          {units.map((unit, index) => (
            <Card
              key={unit.id}
              className="group relative bg-slate-900/50 border-slate-800 hover:border-violet-500/50 transition-all duration-500 cursor-pointer overflow-hidden"
            ...
            >
              ...
              <CardContent className="relative">
                ...
                {/* View Unit Button */}
                <div className="flex items-center gap-2 text-violet-400 font-medium text-sm group-hover:translate-x-2 transition-transform duration-300">
                  Explore Unit
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              ...
              <div key={index} className="text-center">
                <div className="inline-flex items-center justify-center w-16 h-16 rounded-xl bg-violet-500/10 text-violet-400 mb-3">
                  {item.icon}
                </div>
