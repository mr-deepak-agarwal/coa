  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#050816]">
      ...
      <div className="absolute top-1/4 left-10 animate-float-slow opacity-20">
        <Binary className="w-16 h-16 text-violet-400" />
      </div>
      <div className="absolute top-1/3 right-16 animate-float opacity-20">
        <CircuitBoard className="w-20 h-20 text-violet-400" />
      </div>
      <div className="absolute bottom-1/4 left-1/4 animate-float-slow opacity-20">
        <Cpu className="w-14 h-14 text-fuchsia-400" />
      </div>

      {/* Content */}
      <div className="relative z-20 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        {/* Badge */}
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-violet-500/10 border border-violet-500/30 mb-8 animate-fade-in">
          <Sparkles className="w-4 h-4 text-violet-400" />
          <span className="text-sm text-violet-300 font-medium">{courseInfo.code}</span>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-slide-up animation-delay-400">
          <Button
            ...
            className="group relative px-8 py-6 text-lg bg-gradient-to-r from-violet-600 to-indigo-600 hover:from-violet-500 hover:to-indigo-500 text-white font-bold shadow-xl shadow-violet-500/30 hover:shadow-violet-400/50 transition-all duration-300"
          >
          ...
          <Button
            ...
            variant="outline"
            className="group px-8 py-6 text-lg border-2 border-violet-500/50 text-violet-400 hover:bg-violet-500/10 hover:border-violet-400 transition-all duration-300"
          >
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-20 animate-bounce">
        <div className="w-6 h-10 rounded-full border-2 border-violet-500/50 flex items-start justify-center p-2">
          <div className="w-1.5 h-3 bg-violet-400 rounded-full animate-scroll-indicator" />
        </div>
      </div>
    </section>
  );
