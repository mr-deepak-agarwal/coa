...
const Footer = ({ onNavigate }) => {
  ...
  return (
    <footer className="bg-[#050816] border-t border-slate-800">
      {/* Main Footer Content */}
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-3 mb-6">
              <div className="relative">
                <div className="absolute inset-0 bg-gradient-to-r from-violet-400 to-indigo-400 rounded-xl blur-lg opacity-50" />
                <div className="relative bg-slate-900 p-2.5 rounded-xl border border-violet-500/30">
                  <Cpu className="w-7 h-7 text-violet-400" />
                </div>
              </div>
              <div>
                <h3 className="text-xl font-bold bg-gradient-to-r from-violet-400 via-fuchsia-300 to-cyan-400 bg-clip-text text-transparent">
                  {courseInfo.company}
                </h3>
            ...
            <div className="flex items-center gap-4">
              {[
                ...
                <a
                  key={index}
                  href={social.href}
                  className="w-10 h-10 flex items-center justify-center rounded-lg bg-slate-800/50 border border-slate-700 text-slate-400 hover:text-violet-400 hover:border-violet-500/50 transition-all duration-300"
                >
                  {social.icon}
                </a>
              ))}
